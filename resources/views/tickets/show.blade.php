                            ...
                            <dl class="grid grid-cols-1 sm:grid-cols-3">
                                ...
                                <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                                        <span class="inline-flex items-center rounded-md bg-{{ $ticket->ticket_status_color }}-50 px-2 py-1 text-xs font-medium text-{{ $ticket->ticket_status_color }}-600 ring-1 ring-inset ring-{{ $ticket->ticket_status_color }}-500/10/20">{{ $ticket?->ticket_status ?? 'N/A' }} </span>
