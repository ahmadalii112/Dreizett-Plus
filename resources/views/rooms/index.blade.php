                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-gray-900">{{ trans_choice("language.rooms.rooms|room", 1) }}
                                </h1>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <x-action-dropdown label="Options">
                                                        ...
                                                        <div class="py-1" role="none">
                                                            <a href="{{ route('rooms.show', $room->id) }}" class="text-gray-700 hover:bg-gray-100 sm group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                                            ...
                                                            <div x-data="{ isModalOpen: false }" x-cloak>
                                                                ...
                                                                <x-delete-modal
                                                                    ...
                                                                    :modal-title="trans('language.actions.delete', ['action' =>  trans_choice('language.rooms.rooms|room', 2)])"
