<div x-show="{{ $isOpen }}" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
    ...
    <div x-show="{{ $isOpen }}" x-transition:enter="transition ease-out duration-150"
         ...
         x-transition:leave-end="opacity-0 transform translate-y-1/2" @click.away="{{ $closeAction }}"
        ...
        <!-- Modal body -->
        <form action="{{ $formAction }}" method="{{ $formMethod }}" class="from-prevent-multiple-submits">
