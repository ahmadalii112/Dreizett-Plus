    ...
    <main class="isolate">
                ...
                <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                    <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                            <h1 class="text-4xl font-bold tracking-tight text-brand sm:text-4xl">Werde Teil unseres Teams und freue Dich darauf, eine enge Beziehung zu Deinen Patienten aufzubauen.</h1>
                            <p class="relative my-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                Als fürsorglicher Mitarbeiter willst Du einen Arbeitsplatz, an dem Du Menschen wirklich helfen kannst. Wo Du Dich vollumfänglich um Deine Patienten kümmern kannst – und das ohne Zeitdruck oder Dauerstress.
                                <br/><br/>
        ...
        <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Willkommen bei dreizett Plus – Ambulanter Pflegedienst</h2>
                <p class="text-lg leading-8 text-gray-600 mt-6">Als ambulantes Pflegeunternehmen sind wir auf die Betreuung und Pflege von hilfs- und pflegebedürftigen Menschen spezialisiert. Wir bieten unseren Patienten im Rahmen der häuslichen Pflege ein umfangreiches Pflege-, Versorgungs- und Betreuungsprogramm an. Dieses ist individuell auf ihre Bedürfnisse abgestimmt. Der Name „dreizett Plus“ kommt von den 3 Z’s für die wir stehen: Zeit, Zuwendung und Zärtlichkeit. Denn wir wollen nicht nur die körperliche Versorgung gewährleisten, sondern das ganzheitliche Wohlbefinden. Deswegen finden wir für unsere Patienten immer die Zeit für Umarmungen, nette Wörter und ausführliche Gespräche.</p>
                ...
                <div class="lg:flex lg:flex-auto lg:justify-center gap-y-20 gap-x-8 mt-8">
                    ...
                    <div class="mt-6 lg:flex lg:flex-auto lg:justify-center gap-y-20 gap-x-8">
                        <div>
                            ...
                            <p class="text-lg leading-8 text-gray-600 my-6">Bei uns findest Du nahbare Führungskräfte und freundliche Kollegen. Es herrscht immer eine familiäre Atmosphäre.</p>
                        </div>
                        <div>
                            <h3 class="text-1xl font-bold tracking-tight text-gray-600 sm:text-2xl mb-4">Karriere & Perspektive</h3>
                            <p class="text-lg leading-8 text-gray-600 my-6">Du hast die Chance, bei uns zahlreiche Fortbildungs- und Aufstiegsmöglichkeiten wahrzunehmen.</p>
                        </div>
                        <div>
                            <h3 class="text-1xl font-bold tracking-tight text-gray-600 sm:text-2xl mb-4">Mitarbeiterbenefit-System</h3>
                            <p class="text-lg leading-8 text-gray-600 my-6">Als Arbeitgeber im Gesundheitsbereich sorgen wir selbstverständlich auch für das körperliche Wohlbefinden unserer Mitarbeiter.</p>
                        </div>
                        <div>
                            <h3 class="text-1xl font-bold tracking-tight text-gray-600 sm:text-2xl mb-4">Mission & Vision</h3>
                            <p class="text-lg leading-8 text-gray-600 my-6">Wir wollen pflegebedürftige Menschen individuell und umfassend unterstützen.</p>
                        </div>
                    </div>
            </div>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:mt-12">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Dein Wohlbefinden steht für uns an 1. Stelle.</h2>
        ...
        <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:mt-12">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Profitiere von Aufstiegschancen und den Vorteilen einer zukunftssicheren Branche.</h2>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-32 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">Erhalte Zugriff auf über 300 Gesundheitsleistungen und viele weitere Benefits – und sogar deine Familienangehörigen profitieren gleich mit! </p>
            </div>
            <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 mb-6">
                <div>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-32 lg:px-8">
            ...
            <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4 mb-6">
                <div>
                    <dt class="font-bold text-gray-900 text-2xl">1. Deine Bewerbung</dt>
                    <dd class="mt-1 text-gray-600">Bewirb dich über unsere Karriereseite. Sobald Deine Bewerbung eingegangen ist, erhalten wir eine Benachrichtigung.</dd>
                </div>
                <div>
                    <dt class="font-bold text-gray-900 text-2xl">2. Erstgespräch</dt>
                    <dd class="mt-1 text-gray-600">Wir melden uns innerhalb von 24 Stunden bei Dir. Wenn uns Deine Person überzeugt, laden wir Dich in einem kurzen Telefonat zum Vorstellungsgespräch ein.</dd>
                </div>
                <div>
                    <dt class="font-bold text-gray-900 text-2xl">3. Vorstellungsgespräch</dt>
                    <dd class="mt-1 text-gray-600">Im Vorstellungsgespräch lernen wir Dich und das, was Dich ausmacht, besser kennen! Wir erklären Dir mehr über die Stelle und Du kannst uns all Deine Fragen stellen.</dd>
                </div>
                <div>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              <div class="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
                <div class="grid grid-cols-1 gap-y-10 gap-x-8 lg:grid-cols-3">
                  <div>
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900">Wir nehmen Dich an die Hand und führen Dich durch den Bewerbungsprozess</h2>
                    <p class="mt-4 leading-7 text-gray-600">Du hast Rückfragen zu einer Stelle? Dann melde Dich gerne bei uns! In einem persönlichen Telefonat helfen wir gerne weiter. </p>
                  </div>
