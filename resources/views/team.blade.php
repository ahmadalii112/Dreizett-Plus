    ...
    <div class="relative bg-brand">
        ...
        <div class="relative mx-auto max-w-7xl py-24 sm:py-32 lg:py-40 lg:px-8">
            <div class="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                ...
                <p class="mt-6 text-base leading-7 text-white">Wir sind immer auf der Suche nach Personen, die unsere Vision teilen und mit uns gemeinsam die Pflege revolutionieren. Informiere dich auf unserer Karriereseite, welche Vorteile dich bei uns erwarten.</p>
                <div class="mt-8">
                    <a href="/karriere" class="mt-6 rounded-md bg-brand-2 hover:bg-brand-2/80 border-white px-3.5 py-3.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand">Zur Karriereseite →</a>
                </div>
            </div>
        </div>
    </div>
