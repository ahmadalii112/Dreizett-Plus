    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <p class="text-lg font-semibold leading-8 tracking-tight text-brand-2">Wir freuen uns auf das Gespräch mit Ihnen.</p>
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Vielen Dank, Ihr Termin ist bestätigt.</h2>
                <p class="mt-6 text-lg leading-8 text-gray-600">
                    Wir melden uns zum ausgewählten Termin bei Ihnen telefonisch. Einer unserer Berater/innen wird sich die Zeit nehmen um Sie in einem Erstgespräch persönlich zu beraten.<br/>
                    Dabei finden wir heraus, ob und wie wir Ihnen weiterhelfen können. Selbstverständlich kostenlos und unverbindlich.
                </p>
            </div>
