                    ...
                    <form method="post" action="{{ isset($residentialCommunity) ? route('residential-communities.update', $residentialCommunity->id) : route('residential-communities.store') }}" class="from-prevent-multiple-submits">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="care_allowance" class="block text-sm font-medium leading-6 text-gray-900 required">{{ __('Care Allowance') }}</label>
                                ...
                                <div class="sm:col-span-3">
                                    <label for="household_allowance" class="block text-sm font-medium leading-6 text-gray-900 required">{{ __('Household Allowance') }}</label>
                                    <div class="relative mt-2 rounded-md shadow-sm">
                                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                            <span class="text-gray-500 sm:text-sm">€</span>
                                        </div>
                                ...
                                <div class="sm:col-span-3">
                                    <label for="deduction_amount" class="block text-sm font-medium leading-6 text-gray-900 required"> {{ __('Deduction Amount') }}</label>
                                    <div class="mt-2">
