<div  x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
    ...
    <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
        ...
        <!-- Modal body -->
        <form action="{{ route('residential-communities.destroy', $id) }}" method="POST">
            @method('DELETE')
            @csrf
            <div class="mt-4 mb-6">
                <!-- Delete title -->
                ...
                <div class="mt-3 text-center sm:mt-5 ">
                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete Residential Community</h3>
                    <div class="mt-2">
                        <p class="text-sm text-gray-700">Are you sure you want to delete this <span class="font-semibold">"{{ $name }}"</span></p>
                    </div>
                </div>
            </div>
