<x-action-dropdown label="Options">
    ...
    <div class="py-1" role="none">
        <a href="{{ route('residential-communities.show', $residentialCommunity->id) }}" class="text-gray-700 hover:bg-gray-100 sm group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
